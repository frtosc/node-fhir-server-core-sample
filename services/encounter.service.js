...
const create = (base_version, id) => {
    ...
    e.participant = [{individual: {reference: 'Practitioner/xpln-123456', display: 'Prof. Dr. med. Medicone Professorone'}}];
    ...
    e.diagnosis = [{condition: {display:'diagnosi 1'}}, {condition: {display:'diagnosi 2'}}];
    return e;
}